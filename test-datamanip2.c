...
Result test1()
{
    ...
    strcpy(record.fieldData[i].valueSet.stringValue, "i04001");
    i++;
    ...
    strcpy(record.fieldData[i].name, "id");
    record.fieldData[i].dataType = TYPE_STRING;
    strcpy(record.fieldData[i].valueSet.stringValue, "i04002");
    i++;
    ...
    strcpy(record.fieldData[i].name, "id");
    record.fieldData[i].dataType = TYPE_STRING;
    strcpy(record.fieldData[i].valueSet.stringValue, "i04003");
    i++;
    ...
    strcpy(record.fieldData[i].name, "id");
    record.fieldData[i].dataType = TYPE_STRING;
    strcpy(record.fieldData[i].valueSet.stringValue, "i04004");
    i++;
